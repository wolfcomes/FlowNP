...
def parse_args():
    ...
    parser.add_argument('--n_clusters', type=int, default=100, help='Number of clusters for K-means')
...
def gpu_kmeans_clustering(fingerprints_np, n_clusters=100, random_state=42):
    """
...
def cpu_kmeans_clustering(fingerprints_np, n_clusters=100, random_state=42):
    """
...
def generate_molecular_weights(config_path, output_dir=None, n_jobs=1, n_clusters=100, random_state=42):
