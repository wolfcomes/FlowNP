...
from src.data_processing.dataset import MoleculeDataset, PocketLigandDataset
from src.data_processing.samplers import SameSizeMoleculeSampler, SameSizeDistributedMoleculeSampler
...
from src.data_processing.dataset import collate_fn
class PocketLigandDataModule(pl.LightningDataModule):
    ...
    def load_dataset(self, dataset_name: str):
        return PocketLigandDataset(dataset_name, self.dataset_config, prior_config=self.prior_config)
